...
def service_worker_view(request):
    file_path = Path(settings.BASE_DIR) / "service-worker.js"
    response = HttpResponse(file_path.read_text(), content_type="application/javascript")
    response['Service-Worker-Allowed'] = '/'  # Allow service worker scope to cover the entire root
    return response
...
LOGIN_REDIRECT_URL = '/dashboard/'  # Replace with the actual path to your dashboard
