...
class SyncView(APIView):
    ...
    def post(self, request):
        ...
        try:
            ...
            return Response({"error": f"Model '{model_name}' not found in app 'sales'"}, status=status.HTTP_400_BAD_REQUEST)

        errors = []
        success_count = 0

        with transaction.atomic():  # Ensure atomicity for the sync process
        ...
        response_data = {"message": "Sync completed", "success_count": success_count}
        if errors:
